...
export function Metrics() {
  ...
  return (
    <section id="metrics" className="py-24 px-6 relative border-t border-border overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 divide-x divide-border">
          {t.metrics.stats.map((stat, index) => (
            ...
            >
              <div className="text-4xl md:text-5xl font-bold text-foreground mb-3 tracking-tighter drop-shadow-[0_0_15px_rgba(0,242,195,0.2)]">
                {stat.value}
              </div>
